                   ...
                   <div>
                     ...
                     <CardDescription>
                       <div className="flex flex-col gap-0.5">
                         <span>Plate: {v.data?.plateNumber} • Registration: {v.data?.registrationNumber}</span>
                         <span className="font-medium text-slate-700">Applicant: {v.owner_name || v.owner_email || v.owner}</span>
                       </div>
                     </CardDescription>
                   </div>
