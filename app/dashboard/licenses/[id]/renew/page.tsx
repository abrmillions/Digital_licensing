    ...
    try {
      ...
      if (chapaResponse?.status === "success" && chapaResponse?.data?.checkout_url) {
        ...
        if (typeof window !== "undefined") {
          const finalId = license.id || id;
          localStorage.setItem("clms_pending_payment_lic", String(finalId))
          ...
          localStorage.setItem("clms_pending_payment_section", "contractor")
      ...
      let errorMessage = e?.message || "Payment processing failed";
