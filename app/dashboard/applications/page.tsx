          ...
          <div className="space-y-4">
            {applications.map((app) =>
              (() => {
                ...
                const applicantName =
                  app.applicant_name || computeApplicantName(rawApplicant);
                const companyName =
                ...
                return (
                  <Card
                    key={app.id}
                    id={`app-${app.id}`}
                    className="hover:shadow-md transition-shadow scroll-mt-24 target:border-blue-500 target:ring-2 target:ring-blue-500/20"
                  >
                    <CardHeader>
                    ...
                    <CardContent>
                      ...
                      {app.status === "approved" &&
                        (() => {
                          ...
                          return (
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-sm mb-6 border-t pt-4">
                              <div className="space-y-1">
                                <span className="text-muted-foreground block">
                                  Issued:
                                </span>
