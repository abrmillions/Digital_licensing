...
import { Loader2, Upload, User as UserIcon, Mail, Phone, Save, Camera, ArrowLeft } from "lucide-react"
    ...
    <div className="container mx-auto max-w-6xl px-4 py-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage your personal information and profile settings</p>
        </div>
        <Button 
          variant="outline" 
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-4 space-y-6">
          <Card className="overflow-hidden border-none shadow-md">
            <div className="h-32 bg-linear-to-r from-primary/10 to-primary/5"></div>
            <CardContent className="relative px-6 pt-0 pb-6 text-center">
              ...
              <h2 className="text-2xl font-bold mb-1 truncate">{formData.firstName} {formData.lastName}</h2>
              <p className="text-sm text-muted-foreground mb-4 truncate">{formData.email}</p>
