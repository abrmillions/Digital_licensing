...
export default function PaymentSuccessPage() {
  ...
  const [section, setSection] = useState<string>("contractor");
  ...
  useEffect(() => {
    ...
    const verifyPayment = async () => {
      ...
      const s = localStorage.getItem("clms_pending_payment_section") || "contractor";
  ...
  const handleDownload = async (id: string, overrideSection?: string) => {
    try {
      const finalSection = overrideSection || section || "contractor";
