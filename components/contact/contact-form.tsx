...
export default function ContactForm() {
  ...
  const onSubmit = async (data: ContactFormValues) => {
    ...
    try {
      ...
      if (!check.exists_in_system) {
        toast({
          title: "Email Not Recognized",
          description: "This email is not registered in our system. Only registered users can send messages. Please create an account to continue.",
          variant: "destructive",
        });
    ...
    >
      ...
      <div className="grid gap-2">
        ...
        <p className="text-[10px] text-muted-foreground">
          Note: Only registered users can send messages.
        </p>
        {errors.email && (
          <p className="text-xs font-medium text-destructive">
